...
MagneticSensorSPIConfig_s AS5048A = {
  .spi_mode = SPI_MODE1,
  .clock_speed = 1000000,
  .bit_resolution = 14,
...
MagneticSensorAS5048A sensor(SENSOR_nCS, false, SPISettings(4000000, BitOrder::MSBFIRST, SPI_MODE1));
BLDCMotor motor(7);
...
void printSensorStatus()
{
  ...
  Serial.println(F("AS5048 Status:"));
